package com.kujproject.kuj.web.config.handler;

import com.kujproject.kuj.authentication.PrincipalDetails;
...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!(principalDetails.getPassword().equalsIgnoreCase(userPw) && principalDetails.getPassword().equalsIgnoreCase(userPw))) {
            throw new BadCredentialsException(principalDetails.getUsername() + "Invalid password");
        }
        return new UsernamePasswordAuthenticationToken(principalDetails, userPw, principalDetails.getAuthorities());
    }
